...
# استيراد من الملف المركزي بدل تعريفها من جديد
...
# GET ALL ARTICLES - عام بدون توثيق
@router.get("/")
...
# ADD ARTICLE (+5 نقاط) - يتطلب تسجيل دخول
@router.post("/")
def add_article(
...
# DELETE ARTICLE - يتطلب role: admin أو engineer فقط
