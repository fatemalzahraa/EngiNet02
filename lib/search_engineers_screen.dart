...
class SearchEngineersScreen extends StatefulWidget {
  ...
  @override
  State<SearchEngineersScreen> createState() => _SearchEngineersScreenState();
}

class _SearchEngineersScreenState extends State<SearchEngineersScreen> {
  ...
  Future<void> loadEngineers() async {
    try {
      ...
      filtered = engineers.where((e) => e['id'] != currentUserId).toList();
